...
/**
 * Home Carousel — Sliding transform + bullet navigation
 */
(function () {
	'use strict';
	...
	var slides = carousel.querySelectorAll('.pt-home-slide');
	var bullets = carousel.querySelectorAll('.pt-home-bullet');
